...
router.get('/', async (req, res) => {
  try {
    ...
    const countQuery = 'SELECT COUNT(*) as total FROM findtitor_premium_student';
...
router.post('/', async (req, res) => {
  try {
    ...
    const params = [
      id, subject, email, mobile, topix, descripton, 
      ispayed, formattedPaymentDate, stripeSessionId, paymentAmount
    ];
