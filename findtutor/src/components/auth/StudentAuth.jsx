...
import { useAuth } from '../../context/AuthContext'; // Import your existing AuthContext
...
const StudentAuth = () => {
  ...
  const { user, login, loading: authLoading } = useAuth(); // Use your existing AuthContext
  ...
  // ✅ KEY FIX: Auto-navigate when user state changes
  useEffect(() => {
  ...
  // ✅ FIXED: Student login function that works with your AuthContext
  ...
  // ✅ FIXED: Student registration function that works with your AuthContext
  ...
  // ✅ FIXED: Use AuthContext and remove manual navigation
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        // No manual navigation - useEffect will handle it when user state changes
      } else {
